...
DoubleAgent::Graphs offers several helpers for generating gruff graphs.
    ...
    ff = log_entries.select { |e| e.browser_sym == :firefox }
    DoubleAgent::Graphs.pie(ff, :browser, '/path/to/ff-version-share.png', 'Firefox Version Share')

    # A line graph of daily browser family share over time, tricked out with lots of options
