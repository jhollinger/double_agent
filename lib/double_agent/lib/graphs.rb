module DoubleAgent
  ...
  module Graphs
    ...
    # 
    #  logs = DoubleAgent::Logs.entries("/var/log/nginx/my-site.access.log*")
    #  DoubleAgent::Stats.percentages(logs, :browser_family).bar_chart('/path/to/browser-share.png', 'Browser Share')
    #
    # Example 2:
    #
    #  DoubleAgent::Stats.percentages(logs, :browser_family).bar_chart('/path/to/browser-share.png') do |chart|
    ...
    # Example 3:
    # 
    #  blog = DoubleAgent::Stats.counts(logs, :browser_family).bar_chart.to_blob
    #
